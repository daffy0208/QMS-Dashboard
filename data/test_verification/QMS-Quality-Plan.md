...
**VER-002-B Test Project** is a non-regulated system that provides recommendations that influence decisions for internal users within the organization.
...
R2 due to: Decision-impacting recommendations; Safety / legal risk with mitigating factors
