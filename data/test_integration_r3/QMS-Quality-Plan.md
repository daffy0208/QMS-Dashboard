...
**Medical Device Control System** is a regulated system that performs automated actions for external clients, partners, or vendors.
...
R3 due to: Safety / legal / compliance impact; Automated actions; Hard to reverse consequences

**Key Risk Factors:**
- **Users:** External (external clients, partners, or vendors)
- **System Influence:** Automated (performs automated actions)
- **Worst Credible Failure:** Safety_Legal_Compliance (safety, legal, or compliance violations)
- **Reversibility:** Hard
- **Domain Understanding:** Partially
- **Scale:** Multi_team
- **Regulatory Status:** Yes
...
- **Safety testing with hazard analysis**
...
- [Regulatory Standard] - To be identified based on domain
- intake-rules.md - Risk classification rules
- QUALITY_KERNEL.md - Quality-first principles
- [Safety Standard] - To be identified based on domain
