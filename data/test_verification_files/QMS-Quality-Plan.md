...
**VER-004-A Test** is a non-regulated system that provides recommendations that influence decisions for external clients, partners, or vendors.
...
R2 due to: External or public users; Decision-impacting recommendations
